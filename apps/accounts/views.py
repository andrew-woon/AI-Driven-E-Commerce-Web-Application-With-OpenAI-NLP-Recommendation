...
def acprofile(request):
    ...
    if not request.user.is_staff:
        ...
        return redirect("apps.accounts:signin")
    return render(request, "client_profile.html", {'profile': profile, 'user': user})
...
def address(request):
    ...
    return render(request, "client_address.html",{'profile': profile, 'address_list':address_list})
...
def manageadd(request, addid):
        ...
        return render(request, "client_update_address.html",{'address': address,'profile':profile})
...
def orders(request):
    ...
    return render(request, 'client_orders.html', {'orders': orders,'profile':profile})
...
def orderdetail(request, orderid):
    ...
    if request.user.is_authenticated and Profile.objects.filter(user=request.user).exists():
        ...
        return redirect("apps.accounts:signin")
    return render(request, "client_order_detail.html", {'order':order,'profile':profile})
